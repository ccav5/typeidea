...
class Link(models.Model):
    ...
    status = models.PositiveIntegerField(default= STATUS_NORMAL,choices=STATUS_ITEMS,
                                         verbose_name = '状态')
    weight = models.PositiveIntegerField(default =1,choices =zip(range(1,6),range(1,6)),verbose_name='权重高展示顺序靠前')
...
class SideBar(models.Model):
    ...
    title = models.CharField(max_length = 50, verbose_name = '标题')
    diplay_type = models.PositiveIntegerField(default =1 ,choices = SIDE_TYPE,verbose_name = '展示类型')
